...
<head>
    ...
    <title>@yield('title', 'Employee Dashboard') - Performance Management System</title>
            ...
            <div class="sidebar-menu">
                ...
                <ul class="sidebar-menu-items">
                    <li class="sidebar-menu-item" data-title="Dashboard">
                        <a href="{{ route('employee.dashboard') }}" class="sidebar-menu-link {{ request()->routeIs('employee.dashboard') ? 'active' : '' }}">
                ...
                <p class="sidebar-menu-header">Task</p>
                <ul class="sidebar-menu-items">
                    <li class="sidebar-menu-item" data-title="My Tasks">
                        <a href="{{ route('employee.tasks.index') }}" class="sidebar-menu-link {{ request()->routeIs('employee.tasks.*') ? 'active' : '' }}">
                            <span class="sidebar-menu-icon">
                    ...
                    <li class="sidebar-menu-item" data-title="Task History">
                        <a href="#" class="sidebar-menu-link">
                            <span class="sidebar-menu-icon">
                                <i class="fas fa-history"></i>
                            </span>
                            <span class="sidebar-menu-text">Task History</span>
                        </a>
                    </li>
                </ul>
            ...
            <div class="sidebar-footer">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-role">{{ auth()->user()->division->name ?? 'No Division' }}</div>
                    </div>
                </div>
            </div>
        </aside>
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        <div class="user-dropdown-toggle">
                            ...
                            <div class="user-dropdown-info">
                                ...
                                <div class="user-dropdown-role">{{ auth()->user()->division->name ?? 'No Division' }}</div>
                            </div>
