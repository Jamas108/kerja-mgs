        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('employee.employee_profile.index') }}" class="btn btn-light shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('employee.employee_profile.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex gap-2 mt-4">
                                ...
                                <a href="{{ route('employee.employee_profile.index') }}"
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('employee.employee_profile.password.update') }}" method="POST">
                            @csrf
                            @method('PUT')
