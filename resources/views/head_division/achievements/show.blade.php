            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Lihat sertifikat promosi karyawan</p>
                    </div>
                </div>
                <a href="{{ route('head_division.achievements-member.index') }}" class="btn btn-light shadow-sm">
            ...
            <div class="card certificate-card border-0 shadow-sm">
                <div class="card-header bg-gradient-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0">Pratinjau Sertifikat</h5>
                    </div>
                </div>
                ...
                <div class="card-footer bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            <h5 class="mb-1 fw-bold">Sertifikat Promosi</h5>
                            <p class="text-muted small mb-0">
                                <i class="far fa-calendar-check me-1"></i>
                                Diterbitkan pada {{ $achievement->reviewed_at ? $achievement->reviewed_at->format('d F Y') : 'N/A' }}
                            </p>
                        </div>
                        <a href="{{ route('head_division.achievements-member.download', $achievement) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $achievement->employee->name }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            <div class="info-label">Jenis Sertifikat</div>
                            <div class="info-value">Pencapaian Promosi</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            <div class="info-label">Diminta Oleh</div>
                    ...
                    <div class="info-item border-0 mb-0">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">
                                {{ $achievement->director_notes ?? 'Tidak ada catatan tambahan' }}
                            </div>
                        </div>
                    </div>
                </div>
