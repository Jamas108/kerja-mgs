...
<!-- resources/views/head_division/job_desks/create.blade.php -->
@extends('layouts.head_division')

@section('title', 'Create Job Desk')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create New Job Desk</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('head_division.job_desks.store') }}">
                @csrf
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Job Desk
                    </button>
                </div>
            </form>
        </div>
