...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        ...
        <a href="{{ route('head_division.head_division_profile.edit') }}" class="btn btn-primary">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center p-4">
                    ...
                    <div class="stats mt-4 pt-4 border-top">
                        <div class="row g-3">
                            <div class="col-4">
                                <div class="stat-val">{{ $user->assignedJobs->count() }}</div>
                                <div class="stat-lbl">Tugas</div>
                            </div>
                            <div class="col-4">
                                <div class="stat-val">{{ $user->awards_count }}</div>
                                <div class="stat-lbl">Award</div>
                            </div>
                            <div class="col-4">
                                <div class="stat-val">{{ $user->performance_score ? number_format($user->performance_score, 1) : '-' }}</div>
                                <div class="stat-lbl">Kinerja</div>
                            </div>
                        </div>
                    </div>
                </div>
