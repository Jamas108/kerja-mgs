...
<style>
    ...
    @media (max-width: 767.98px) {
        ...
        /* Hide certain columns on mobile via DataTables responsive */
        .dtr-hidden {
            display: none;
        }
    }
...
<div class="page-header mb-4">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
        <div class="flex-grow-1">
            <h2 class="h3 mb-2 text-gray-800 fw-bold">Kinerja Karyawan</h2>
        ...
        <div class="btn-group-mobile">
            ...
            <a href="{{ route('head_division.performances.report') }}" class="btn btn-primary">
                <i class="fas fa-file-alt me-2"></i>Laporan Divisi
            </a>
        </div>
    </div>
</div>
                ...
                <div class="card mb-3 border-left-primary shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <small class="text-muted d-block mb-1">Tugas Selesai</small>
                        ...
                        <div class="mb-3">
                            <small class="text-muted d-block mb-2">Nilai Kinerja</small>
                            @if ($employee->performance_score)
                        ...
                        <div class="mb-3">
                            ...
                            @else
                                <span class="badge bg-secondary w-100 py-2">Belum dinilai</span>
                            @endif
                        </div>
