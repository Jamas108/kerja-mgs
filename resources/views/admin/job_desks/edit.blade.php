...
<div class="container-fluid">
    ...
    <div class="page-header d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-secondary mb-0">{{ $manage_job_desk->title }}</p>
        </div>
    ...
    @if($manage_job_desk->assignments->count() > 0)
        ...
        <div class="d-flex align-items-start">
            ...
            <div>
                ...
                <p class="mb-0 mt-1 small">
                    Tugas ini sudah ditugaskan kepada <strong>{{ $manage_job_desk->assignments->count() }} karyawan</strong>.
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.manage_job_desks.update', $manage_job_desk) }}" id="jobDeskForm">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           id="title"
                           name="title"
                           value="{{ old('title', $manage_job_desk->title) }}"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              required>{{ old('description', $manage_job_desk->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                           ...
                           id="deadline"
                           name="deadline"
                           value="{{ old('deadline', $manage_job_desk->deadline->format('Y-m-d')) }}"
                           required>
                    @error('deadline')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <small class="form-text text-muted">
                        ...
                        Deadline saat ini: <strong>{{ $manage_job_desk->deadline->format('d M Y') }}</strong>
                    </small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <small class="form-text text-muted">
                        ...
                        @if($manage_job_desk->assignments->count() > 0)
                            Karyawan yang sudah dipilih sebelumnya: <strong>{{ $manage_job_desk->assignments->count() }}</strong>
                        @endif
                    </small>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach($manage_job_desk->assignments as $assignment)
                        <tr>
                            <td>
