    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <a href="{{ route('director.reviews.index') }}" class="btn btn-primary btn-block w-100">
                            <i class="fas fa-clipboard-check"></i> Review Tasks
                        </a>
                    </div>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> You have {{ $pendingReviews }} tasks pending for review.
                    </div>
                </div>
            </div>
        </div>
