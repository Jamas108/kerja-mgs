        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('director.signatures.update', $signature) }}" method="POST"
                            id="editSignatureForm">
                            @csrf
                            @method('PUT')

                            @foreach ($directors as $director)
                                <input type="text" value="{{ $director->id }}" hidden>
                            @endforeach

                            <div class="mb-3">
                                <label for="title" class="form-label">Judul/Keterangan</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    id="title" name="title" value="{{ old('title', $signature->title) }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <img src="{{ $signature->image_url }}" alt="Tanda Tangan" class="img-thumbnail"
                                        style="height: 100px; max-width: 300px; background-color: #f8f9fa;">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="signature-pad-container border rounded p-3 bg-light">
                                    ...
                                    <canvas id="signaturePad" class="signature-pad border rounded w-100"
                                        height="200"></canvas>
